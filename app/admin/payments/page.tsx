...
export default function AdminPaymentsPage() {
    ...
    useEffect(() => {
        ...
        setList([
            ...
            { id: 204, name: "INV/2026/004", partner_id: [4, "Alpha Inc"], invoice_date: "2026-02-07", payment_state: "paid", amount_total: 450 },
        ]);
        setLoading(false);
    }, []);
    ...
    return (
        <div className="p-8">
            <h1 className="text-2xl font-bold text-text-heading">Payments</h1>
            <p className="mt-2 text-text-muted">Paid and partial payments from invoices (Odoo).</p>
