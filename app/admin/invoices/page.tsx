...
export default function InvoicesPage() {
  ...
  return (
    <div className="p-8">
      ...
      <p className="mt-2 text-text-muted">From Odoo API: get_invoices.</p>
        ...
        <table className="w-full text-left text-sm">
          <thead className="border-b border-border-color bg-gray-50/80">
            <tr>
              ...
              <th className="px-4 py-3 font-medium text-text-heading">Payment</th>
          ...
          <tbody className="divide-y divide-border-color">
            {list.map((inv) => (
              <tr key={inv.id} className="hover:bg-slate-50/50">
                ...
                <td className="px-4 py-3">{inv.state}</td>
