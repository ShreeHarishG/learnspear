        ...
        <div className="flex flex-col lg:flex-row gap-8 max-w-6xl mx-auto">
            ...
            <div className="flex-1 bg-white p-8 rounded-2xl shadow-sm border border-border-color">
                ...
                <div className="space-y-4">
                    {[1, 2, 3].map((order) => (
                        <div key={order} className="border border-border-color rounded-xl p-6 hover:shadow-md transition-shadow group">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-text-heading text-lg group-hover:text-primary transition-colors">
                                            <Link href={`/user/orders/${order}`}>Order #S000{order}</Link>
                                        </h3>
                            ...
                            <div className="flex justify-between items-center border-t border-border-color pt-4 pl-16">
                                <div className="font-bold text-text-heading text-lg">$1,200.00</div>
                                <div className="flex gap-3">
                                    <button className="text-sm font-semibold text-text-muted hover:text-text-heading transition-colors">
                                        Invoice
                                    </button>
                                    <Link href={`/user/orders/${order}`} className="text-sm font-bold text-primary hover:underline flex items-center gap-1">
