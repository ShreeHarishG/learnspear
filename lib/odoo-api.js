...
const odooAPI = {
  ...
  /** GET /api/products - returns { status, data: [{ id, name, list_price }] } */
  getProducts: async () => {
    const response = await apiClient.get("/api/products");
    return response.data;
  },

  /** GET /api/subscriptions - returns { status, data: [{ id, name, partner_id, plan_id, state, amount_total, start_date }] } */
  ...
  /** GET /api/plans - returns { status, data: [{ id, name, billing_period, price }] } */
  getPlans: async () => {
    const response = await apiClient.get("/api/plans");
    return response.data;
  },

  /** GET /api/invoices - returns { status, data: [{ id, name, partner_id, invoice_date, amount_total, payment_state, state }] } */
  getInvoices: async () => {
